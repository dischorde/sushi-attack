...
/***/ function(module, exports, __webpack_require__) {
	...
	var openInfoBar = function openInfoBar() {
	  ...
	  infoBar.addEventListener("mouseout", function () {
	    setTimeout(function () {
	      closeInfoBar();
	    }, 1000);
	  });
	...
	var Character = function () {
	  ...
	  _createClass(Character, [{
	    ...
	    value: function bodyCoords(curX, curY) {
	      var adjXPony = Math.floor(this.width() * .5);
	      var adjXFace = Math.floor(this.width() * .35);
	      var adjXBody = Math.floor(this.width() * .26);
	      var adjXFeet = Math.floor(this.width() * .16);
	
	      var adjYPony = Math.floor(this.height() * .58);
	      var adjYFace = Math.floor(this.height() * .45);
	      var adjYBody = Math.floor(this.height() * .24);
	      var adjYFeet = Math.floor(this.height() * .19);
	    ...
	    value: function activateShield() {
	      ...
	      this.shielded = true;
	      // TODO: change color / sizing to look good
